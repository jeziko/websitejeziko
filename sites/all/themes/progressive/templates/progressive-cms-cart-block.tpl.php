    ...
    <ul class="list-unstyled">
      <?php foreach($items as $item): ?>
        <li>
          ...
          <?php endif; ?>
          <a href="<?php print url('progressive/remove-from-cart/' . $item->nid); ?>" class="product-remove">
          ...
          <div class="product-price"><span class = "qty-block"><?php print $item->qty; ?> x </span><span class="price"><?php print variable_get('uc_currency_sign', '$') . number_format($item->sell_price, 2); ?></span></div>
