  ...
  <div class="row">
    ...
    <div class="image-box">
      ...
      <div class="thumblist-box load">
        ...
        <div id="thumblist" class="thumblist">
          <?php foreach(element_children($content['uc_product_image']) as $key): $content['uc_product_image'][$key]['#image_style'] = 'product_100x100';?>
    ...
    <div class="col-sm-7 col-md-7">
      ...
      <div class="price-box">
        ...
        <span class="price"><?php $content['sell_price']['#title'] = ''; print render($content['sell_price']); ?></span>
      </div>
